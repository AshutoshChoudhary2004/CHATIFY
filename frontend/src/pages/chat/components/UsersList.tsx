...
import { sortUsersByOnlineStatus } from "@/lib/utils.ts";

const UsersList = () => {
	const { users : usersList, selectedUser, isLoading, setSelectedUser, onlineUsers } = useChatStore();	
	const users = usersList.sort(sortUsersByOnlineStatus);
